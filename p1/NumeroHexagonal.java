...
public class NumeroHexagonal {
    ...
    /*
    La complejidad asintotica es del orden O(n²), ya que el tamaño del problema se inluye en la fórmula, con n²
    */
    ...
    /*
    La complejidad asintotica es del orden O(n), ya que la parte más costosa del método (bucle for)
    se ejecuta n veces, el resto son constantes que no aumentan con el tamaño del problema.
    */
